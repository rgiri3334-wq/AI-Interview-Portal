...
// ΓöÇΓöÇ Stage pipeline config ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const STAGES = [
...
// ΓöÇΓöÇ Countdown Timer (With 15-Min Expiration) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Score Tier Badge ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const TIER_CONFIG = {
  'Exceptional': { color: 'text-white', bg: 'bg-slate-900', border: 'border-slate-800', emoji: '≡ƒÅå' },
  'Strong': { color: 'text-slate-800', bg: 'bg-emerald-50', border: 'border-emerald-200', emoji: 'Γ¡É' },
  'Good': { color: 'text-slate-800', bg: 'bg-blue-50', border: 'border-blue-200', emoji: 'Γ£à' },
  'Needs Development': { color: 'text-slate-600', bg: 'bg-amber-50', border: 'border-amber-200', emoji: '≡ƒôê' },
};
...
// ΓöÇΓöÇ Animations ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
export default function CandidateHome() {
  ...
  if (loading || isMarkingNoShow || isCancelling) return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-slate-600 font-bold uppercase tracking-widest text-xs">Syncing PortalΓÇª</p>
      </div>
    </div>
  );
  ...
  return (
    <PageWrapper className="pb-20">
      ...
      {/* ΓöÇΓöÇ HERO HEADER (Gradient & Glass) ΓöÇΓöÇ */}
      ...
      <main className="px-4 sm:px-8 max-w-5xl mx-auto -mt-16 relative z-20">
        <motion.div variants={containerVariants} initial="hidden" animate="show" className="space-y-6">
          ...
          {/* ΓöÇΓöÇ APPLICATION STATUS PIPELINE ΓöÇΓöÇ */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* ΓöÇΓöÇ INTERVIEW ACTION CARD ΓöÇΓöÇ */}
              ...
              {booking ? (
                <div className="flex flex-col flex-1">
                  <div className="bg-slate-50 rounded-2xl border border-slate-100 p-6 mb-6">
                    ...
                    <p className="text-red-600 font-extrabold text-lg">{booking.start_time} ΓÇô {booking.end_time}</p>
                  ...
                  <div className="mt-auto">
                    ...
                    {isInterviewReady && (
                      <p className="text-center text-xs font-bold text-red-600 mt-3 animate-pulse">
                        ΓÜá∩╕Å You have 15 minutes to join!
                      </p>
                    )}
                    <button onClick={handleCancelSlot} disabled={isCancelling}
                      ...
                      {isCancelling ? "CancellingΓÇª" : "Cancel / Reschedule Slot"}
                    </button>
                  </div>
                </div>
              ) : app.is_completed ? (
            ...
            {/* ΓöÇΓöÇ METRICS & DETAILS CARD ΓöÇΓöÇ */}
