...
filepath = r"c:\Users\Niraj Singh\OneDrive\Documents\Desktop\Interview portal\frontend\src\pages\AdminPanel.jsx"

with open(filepath, "r", encoding="utf-8") as f:
    content = f.read()

target_start = '<AnimatePresence mode="wait">'
...
print("SUCCESS: Python replacement executed!")
